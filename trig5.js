...
let desktopVideoSrc = 'ani/trigC.mp4';
let mobileVideoSrc = 'ani/trigCmob.mp4';
...
answerOptions.addEventListener('click', function(event) {
  if (event.target.tagName === 'INPUT') {
    ...
    let nextVideo = isCorrectAnswer ? 'ani/trig5O.mp4' : 'ani/trig5X.mp4';
